...
public class OvcController {
    ...
    public Response saveSettings(
            @FormParam("ollamaUrl") String ollamaUrl,
            @FormParam("ollamaModel") String ollamaModel,
            @FormParam("ollamaNumGpu") String ollamaNumGpu,
            @FormParam("ollamaNumCtx") String ollamaNumCtx,
            @FormParam("ollamaKeepAlive") String ollamaKeepAlive,
            @FormParam("provider") String provider,
            @FormParam("transcriptionModel") String transcriptionModel,
            @FormParam("transcriptionCachePath") String transcriptionCachePath,
        ...
        settingsService.saveSettings(
            ollamaUrl,
            ollamaModel,
            parseOrDefault(ollamaNumGpu, -1),
            parseOrDefault(ollamaNumCtx, 0),
            ollamaKeepAlive,
            provider,
            transcriptionModel,
